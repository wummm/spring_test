...
import com.metis.backend.system.dao.MenuDao;
...
public class MenuServiceImpl implements MenuService {
	...
	public int save(MenuDO menu) {
		...
		RoleMenuDO menuDao = new RoleMenuDO();
		menuDao.setRoleId(Long.valueOf(menu.getUid()));
		menuDao.setMenuId(menu.getMenuId());
		roleMenuMapper.save(menuDao);
		return r;
	}
